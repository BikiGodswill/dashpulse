    ...
    <div className="flex items-center gap-2 mt-2">
      {[0, 1, 2].map((i) => (
        <div
          ...
          style={{
            background: i < fill ? colors[level] : "rgba(255,255,255,0.08)",
          }}
        />
      ))}
      <span className="text-xs capitalize" style={{ color: colors[level] }}>
        {level}
      </span>
    </div>
  );
      ...
      <div className="min-h-screen flex items-center justify-center p-4 hero-bg">
        ...
        <div className="w-full max-w-sm animate-slide-up relative z-10">
          <div className="glass-card p-8 text-center">
            ...
            <h1
              className="heading-font text-2xl mb-2"
    ...
    <div className="min-h-screen flex items-center justify-center p-4 hero-bg">
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8 items-start relative z-10 animate-slide-up">
        ...
        <div className="hidden md:block pt-4">
          ...
          <h2
            className="heading-font text-3xl mb-3"
            style={{ color: "var(--text-primary)", letterSpacing: "-0.02em" }}
          >
          ...
          >
            Join thousands of businesses using DashPulse to understand their
          ...
          >
            <p
              ...
              style={{ color: "var(--text-secondary)", lineHeight: 1.7 }}
            >
              "DashPulse transformed how we understand our business. The
              real-time insights are game-changing."
            </p>
            <p
        ...
        <div>
          ...
          <div className="glass-card p-7">
            <h1
              className="heading-font text-2xl mb-1"
              style={{ color: "var(--text-primary)", letterSpacing: "-0.02em" }}
            >
              Create account
            </h1>
