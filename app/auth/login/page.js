  ...
  async function handleLogin(e) {
    ...
    if (error) {
      ...
      if (msg.includes('invalid login') || msg.includes('invalid credentials')) {
        ...
        setFormError('Please verify your email address before signing in. Check your inbox.');
    ...
    <div className="min-h-screen flex items-center justify-center p-4 hero-bg">
      ...
      <div className="w-full max-w-sm animate-slide-up relative z-10">
        ...
        <div className="flex items-center gap-3 mb-8 justify-center">
          ...
          <div>
            <div className="heading-font text-lg" style={{ color: 'var(--text-primary)', letterSpacing: '-0.01em' }}>
              DashPulse
            </div>
        ...
        {!isSupabaseConfigured && (
          ...
          >
            ...
            <span>
              Supabase is not configured — email sign-in is unavailable.
              Use <strong>Demo mode</strong> to explore the dashboard.
            </span>
          </div>
        )}
